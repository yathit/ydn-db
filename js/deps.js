...
goog.addDependency("../../../ydn-db/js/ydn/db/storage.js", ['ydn.db.Storage'], ['goog.userAgent.product', 'ydn.async', 'ydn.db.LocalStorage', 'ydn.db.IndexedDb', 'ydn.db.adapter.IndexedDb', 'ydn.db.MemoryStore', 'ydn.db.WebSql', 'ydn.object', 'ydn.db.io.Query', 'ydn.db.RichStorage_', 'ydn.db.Core']);
...
goog.addDependency("../../../ydn-db/js/ydn/db/tr/storage.js", ['ydn.db.tr.Storage'], ['ydn.db.Core', 'ydn.db.tr.IndexedDb', 'ydn.db.tr.WebSql', 'ydn.db.tr.LocalStorage', 'ydn.db.tr.SessionStorage', 'ydn.db.tr.SimpleStorage', 'ydn.db.tr.TxService', 'ydn.db.tr.Service', 'ydn.db.tr.TxStorage']);
goog.addDependency("../../../ydn-db/js/ydn/db/tr/storage_service.js", ['ydn.db.tr.Service'], ['ydn.db.CoreService', 'ydn.db.tr.Mutex']);
