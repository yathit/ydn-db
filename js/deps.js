...
goog.addDependency("../../../ydn-db/js/ydn/db/sql/req/indexed_db.js", ['ydn.db.sql.req.IndexedDb'], ['ydn.db.index.req.IndexedDb', 'ydn.db.sql.req.IRequestExecutor', 'ydn.db.sql.req.idb.Node']);
...
goog.addDependency("../../../ydn-db/js/ydn/db/sql/req/websql.js", ['ydn.db.sql.req.WebSql'], ['ydn.db.index.req.WebSql', 'ydn.db.sql.req.SqlQuery', 'ydn.db.sql.req.IRequestExecutor', 'ydn.db.sql.req.websql.Node']);
goog.addDependency("../../../ydn-db/js/ydn/db/sql/req/idb/node.js", ['ydn.db.sql.req.idb.Node'], ['ydn.db.Iterator', 'ydn.db.KeyRange', 'ydn.error.ArgumentException']);
goog.addDependency("../../../ydn-db/js/ydn/db/sql/req/websql/node.js", ['ydn.db.sql.req.websql.Node'], ['ydn.db.schema.Store']);
