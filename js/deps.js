...
goog.addDependency("../../../ydn-db/js/ydn/db/req/abstract_request_executor.js", ['ydn.db.req.RequestExecutor'], ['goog.async.Deferred', 'goog.debug.Logger', 'ydn.db.Query', 'ydn.db.Key', 'ydn.db.InternalError']);
...
goog.addDependency("../../../ydn-db/js/ydn/db/req/memory_store.js", ['ydn.db.req.SimpleStore'], ['goog.asserts', 'goog.async.Deferred', 'goog.Timer', 'ydn.db.req.RequestExecutor']);
