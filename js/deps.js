...
goog.addDependency("../../../ydn-db/js/dev.js", [], ['goog.debug.Console', 'goog.debug.Logger', 'goog.debug.LogManager', 'ydn.db.Storage', 'ydn.db.TxStorage']);
...
goog.addDependency("../../../ydn-db/js/ydn/db/storage.js", ['ydn.db.Storage'], ['goog.userAgent.product', 'ydn.async', 'ydn.db.req.IndexedDb', 'ydn.db.req.SimpleStore', 'ydn.db.req.WebSql', 'ydn.object', 'ydn.db.RichStorage_', 'ydn.db.tr.Storage', 'ydn.db.TxStorage', 'ydn.db.io.Query', 'ydn.db.io.Key', 'ydn.db.io.QueryService', 'ydn.db.io.QueryServiceProvider']);
goog.addDependency("../../../ydn-db/js/ydn/db/tx_storage.js", ['ydn.db.TxStorage'], ['ydn.error.NotSupportedException', 'ydn.db.tr.TxStorage', 'ydn.db.io.QueryService']);
...
goog.addDependency("../../../ydn-db/js/ydn/db/base/query.js", ['ydn.db.Query'], ['goog.functions', 'ydn.db.KeyRange']);
