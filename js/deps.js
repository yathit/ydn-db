...
goog.addDependency("../../../ydn-db/js/ydn/db/storage.js", ['ydn.db.Storage'], ['goog.userAgent.product', 'ydn.async', 'ydn.db.req.IndexedDb', 'ydn.db.req.SimpleStore', 'ydn.db.req.WebSql', 'ydn.object', 'ydn.db.RichStorage_', 'ydn.db.tr.Storage', 'ydn.db.TxStorage', 'ydn.db.io.Query', 'ydn.db.io.QueryService', 'ydn.db.io.QueryServiceProvider']);
