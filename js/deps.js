...
goog.addDependency("../../../ydn-db/js/ydn/db/core/storage.js", ['ydn.db.core.Storage'], ['goog.userAgent.product', 'ydn.async', 'ydn.db.core.IStorage', 'ydn.db.core.TxQueue', 'ydn.db.tr.Storage', 'ydn.object']);
goog.addDependency("../../../ydn-db/js/ydn/db/core/tx_queue.js", ['ydn.db.core.TxQueue'], ['ydn.db.core.req.IndexedDb', 'ydn.db.core.req.SimpleStore', 'ydn.db.core.req.WebSql', 'ydn.db.tr.TxQueue', 'ydn.db.core.IStorage', 'ydn.error.NotSupportedException']);
...
goog.addDependency("../../../ydn-db/js/ydn/db/index/storage.js", ['ydn.db.index.Storage'], ['ydn.db.index.TxQueue', 'ydn.db.core.Storage']);
...
goog.addDependency("../../../ydn-db/js/ydn/db/index/tx_queue.js", ['ydn.db.index.TxQueue'], ['ydn.db.Iterator', 'ydn.db.core.TxQueue', 'ydn.db.index.req.IRequestExecutor', 'ydn.db.index.req.IndexedDb', 'ydn.db.index.req.WebSql', 'ydn.db.index.req.SimpleStore', 'ydn.db.index.IStorage']);
...
goog.addDependency("../../../ydn-db/js/ydn/db/sql/tx_queue.js", ['ydn.db.sql.TxQueue'], ['ydn.db.Iterator', 'ydn.db.index.TxQueue', 'ydn.db.sql.IStorage', 'ydn.db.sql.req.IRequestExecutor', 'ydn.db.sql.req.IndexedDb', 'ydn.db.sql.req.WebSql', 'ydn.db.sql.req.SimpleStore']);
