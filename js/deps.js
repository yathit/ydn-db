...
goog.addDependency("../../../ydn-db/js/ydn/db/storage.js", ['ydn.db.Storage'], ['goog.userAgent.product', 'ydn.async', 'ydn.db.req.IndexedDb', 'ydn.db.req.SimpleStore', 'ydn.db.req.WebSql', 'ydn.object', 'ydn.db.RichStorage_', 'ydn.db.tr.Storage', 'ydn.db.IStorage', 'ydn.db.io.QueryService', 'ydn.db.io.QueryServiceProvider']);
goog.addDependency("../../../ydn-db/js/ydn/db/tx_storage.js", ['ydn.db.TxStorage'], ['ydn.error.NotSupportedException', 'ydn.db.tr.TxStorage']);
