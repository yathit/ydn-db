...
ydn.db.tr.IndexedDb.prototype.doTransaction = function(fnc, scopes, mode)
{
   ...
   * queue.
   */
  if (this.getIdxDb() && !this.mu_tx_.isActiveAndAvailable()) {
     ...
     * @type {!IDBTransaction}
     */
    var tx = this.getIdxDb().transaction(scopes, /** @type {number} */ (mode));
 ...
 */
ydn.db.tr.IndexedDb.prototype.getActiveTx = function() {
