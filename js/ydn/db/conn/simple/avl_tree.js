...
goog.provide('ydn.db.con.simple.AvlTree.Node');
 ...
 * @private
 */
ydn.db.con.simple.AvlTree.DEFAULT_COMPARATOR_ = function(a, b) {
 ...
 *
 * @type {ydn.db.con.simple.AvlTree.Node}
 * @private
 */
ydn.db.con.simple.AvlTree.prototype.root_ = null;
 ...
 * @private
 */
ydn.db.con.simple.AvlTree.prototype.comparator_ = null;
 ...
 * @private
 */
ydn.db.con.simple.AvlTree.prototype.minNode_ = null;
 ...
 * @private
 */
ydn.db.con.simple.AvlTree.prototype.maxNode_ = null;
 ...
 * @override
 */
ydn.db.con.simple.AvlTree.prototype.add = function(value) {
  // If the tree is empty, create a root node with the specified value
  if (this.root_ == null) {
    this.root_ = new ydn.db.con.simple.AvlTree.Node(value);
  ...
  this.traverse_(function(node) {
    ...
    if (this.comparator_(node.value, value) > 0) {
      retNode = node.left;
      if (node.left == null) {
        newNode = new ydn.db.con.simple.AvlTree.Node(value, node);
        node.left = newNode;
 ...
 * @override
 */
ydn.db.con.simple.AvlTree.prototype.remove = function(value) {
 ...
 */
ydn.db.con.simple.AvlTree.prototype.clear = function() {
  this.root_ = null;
  this.minNode_ = null;
  this.maxNode_ = null;
};
 ...
 * @override
 */
ydn.db.con.simple.AvlTree.prototype.contains = function(value) {
 ...
 * @override
 */
ydn.db.con.simple.AvlTree.prototype.getCount = function() {
 ...
 */
ydn.db.con.simple.AvlTree.prototype.getKthValue = function(k) {
 ...
 */
ydn.db.con.simple.AvlTree.prototype.getMinimum = function() {
 ...
 */
ydn.db.con.simple.AvlTree.prototype.getMaximum = function() {
 ...
 */
ydn.db.con.simple.AvlTree.prototype.getHeight = function() {
 ...
 */
ydn.db.con.simple.AvlTree.prototype.getValues = function() {
  var ret = [];
 ...
 */
ydn.db.con.simple.AvlTree.prototype.inOrderTraverse =
    function(func, opt_startValue) {
      ...
      var startNode;
      if (opt_startValue instanceof ydn.db.con.simple.AvlTree.Node) {
 ...
 * from the node exclusive.
 */
ydn.db.con.simple.AvlTree.prototype.reverseOrderTraverse =
    function(func, opt_startValue) {
      // If our tree is empty, return immediately
      if (!this.root_) {
        return;
 ...
 * @param {ydn.db.con.simple.AvlTree.Node=} opt_startNode The node at which the
 *     traversal begins.
 * @param {ydn.db.con.simple.AvlTree.Node=} opt_endNode The node at which the
 *     traversal ends.
 * @private
 */
ydn.db.con.simple.AvlTree.prototype.traverse_ =
 ...
 * added or removed).
 *
 * @param {ydn.db.con.simple.AvlTree.Node} node Node to begin balance from.
 * @private
 */
ydn.db.con.simple.AvlTree.prototype.balance_ = function(node) {
 ...
 *
 * @param {ydn.db.con.simple.AvlTree.Node} node Pivot node to rotate from.
 * @private
 */
ydn.db.con.simple.AvlTree.prototype.leftRotate_ = function(node) {
 ...
 * @private
 */
ydn.db.con.simple.AvlTree.prototype.rightRotate_ = function(node) {
  // Re-assign parent-child references for the parent of the node being removed
  if (node.isLeftChild()) {
 ...
 *
 * @param {ydn.db.con.simple.AvlTree.Node} node The node to be removed.
 * @private
 */
ydn.db.con.simple.AvlTree.prototype.removeNode_ = function(node) {
 ...
 * @param {ydn.db.con.simple.AvlTree.Node=} opt_rootNode Optional root node.
 * @return {ydn.db.con.simple.AvlTree.Node} The node at the specified index.
 * @private
 */
ydn.db.con.simple.AvlTree.prototype.getKthNode_ = function(k, opt_rootNode) {
 ...
 *
 * @param {ydn.db.con.simple.AvlTree.Node=} opt_rootNode Optional root node.
 * @return {ydn.db.con.simple.AvlTree.Node} The node with the smallest value in
 *     the tree.
 * @private
 */
ydn.db.con.simple.AvlTree.prototype.getMinNode_ = function(opt_rootNode) {
  if (!opt_rootNode) {
 ...
 *
 * @param {ydn.db.con.simple.AvlTree.Node=} opt_rootNode Optional root node.
 * @return {ydn.db.con.simple.AvlTree.Node} The node with the largest value in
 *     the tree.
 * @private
 */
ydn.db.con.simple.AvlTree.prototype.getMaxNode_ = function(opt_rootNode) {
  if (!opt_rootNode) {
 ...
 * @param {ydn.db.con.simple.AvlTree.Node=} opt_parent Optional parent node.
 * @constructor
 */
ydn.db.con.simple.AvlTree.Node = function(value, opt_parent) {
  goog.asserts.assertInstanceof(value, ydn.db.con.simple.Node);
  /**
 ...
 * @type {ydn.db.con.simple.AvlTree.Node?}
 */
ydn.db.con.simple.AvlTree.Node.prototype.left = null;
 ...
 * @type {ydn.db.con.simple.AvlTree.Node?}
 */
ydn.db.con.simple.AvlTree.Node.prototype.right = null;
 ...
 * @type {number}
 */
ydn.db.con.simple.AvlTree.Node.prototype.height = 1;
 ...
 *    child of its parent.
 */
ydn.db.con.simple.AvlTree.Node.prototype.isRightChild = function() {
 ...
 *    child of its parent.
 */
ydn.db.con.simple.AvlTree.Node.prototype.isLeftChild = function() {
