 ...
 * @constructor *
 */
ydn.db.Storagei = function(opt_dbname, opt_schema, opt_options) {
  goog.base(this, opt_dbname, opt_schema, opt_options);

};
goog.inherits(ydn.db.Storagei, ydn.db.crud.Storage);


goog.exportSymbol('ydn.db.Storage', ydn.db.Storagei);
