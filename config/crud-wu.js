...
goog.provide('ydn.db.Storagewu');
goog.require('ydn.db.con.exports');
goog.require('ydn.db.crud.Storage.wu');
 ...
 * @constructor *
 */
ydn.db.Storagewu = function(opt_dbname, opt_schema, opt_options) {
  goog.base(this, opt_dbname, opt_schema, opt_options);

};
goog.inherits(ydn.db.Storagewu, ydn.db.crud.Storage);


goog.exportSymbol('ydn.db.Storage', ydn.db.Storagewu);
