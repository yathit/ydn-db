...
goog.provide('ydn.db.Storageiswu');
goog.require('ydn.db.crud.Storage');
goog.require('ydn.db.con.exports');
goog.require('ydn.db.crud.Storage');
goog.require('ydn.db.crud.Storage.iswu');
 ...
 * @constructor *
 */
ydn.db.Storageiswu = function(opt_dbname, opt_schema, opt_options) {
  goog.base(this, opt_dbname, opt_schema, opt_options);

};
goog.inherits(ydn.db.Storageiswu, ydn.db.crud.Storage);


goog.exportSymbol('ydn.db.Storage', ydn.db.Storageiswu);
