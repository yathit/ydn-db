...
goog.provide('ydn.db.Storageis');
goog.require('ydn.db.con.exports');
goog.require('ydn.db.crud.Storage');
goog.require('ydn.db.crud.Storage.is');
 ...
 * @constructor *
 */
ydn.db.Storageis = function(opt_dbname, opt_schema, opt_options) {
  goog.base(this, opt_dbname, opt_schema, opt_options);

};
goog.inherits(ydn.db.Storageis, ydn.db.crud.Storage);
