...
goog.provide('ydn.db.query.EKeyRCursor');
 ...
 * @param {ydn.db.query.EKeyRCursor=} opt_prev_cursor previous cursor, to resume cursor
 * location.
 ...
 * @struct
 */
ydn.db.query.EKeyRCursor = function(cursors, opt_prev_cursor, opt_key,
                                    opt_primary_key) {
  goog.base(this, cursors, opt_prev_cursor, opt_key, opt_primary_key)
};
goog.inherits(ydn.db.query.EKeyRCursor, ydn.db.query.RestrictionCursor);
 ...
 */
ydn.db.query.EKeyRCursor.DEBUG = false;
 ...
 */
ydn.db.query.EKeyRCursor.prototype.logger =
    goog.debug.Logger.getLogger('ydn.db.query.EKeyRCursor');
 ...
 * @private
 */
ydn.db.query.EKeyRCursor.prototype.openSingle_ = function(cursor) {
  var me = this;
  var i = 0;
  /**
   * On success handler.
 ...
 * @private
 */
ydn.db.query.EKeyRCursor.prototype.openPrimaryKeyMerge_ = function() {
  ...
  var listenCursor = function(i_cursor) {
    ...
    cursor.onSuccess = function(opt_key, opt_p_key, opt_value) {
      result_count++;
      if (ydn.db.query.EKeyRCursor.DEBUG) {
 ...
 * @private
 */
ydn.db.query.EKeyRCursor.prototype.openSecondaryKeyMerge_ = function() {
  var total = this.cursors_.length;
  var result_count = 0;
  var keys = [];
  var primary_keys = [];
 ...
 */
ydn.db.query.EKeyRCursor.prototype.continuePrimaryKey = function(key) {
 ...
 */
ydn.db.query.EKeyRCursor.prototype.continueEffectiveKey = function(opt_key) {
 ...
 */
ydn.db.query.EKeyRCursor.prototype.advance = function(n) {
 ...
 */
ydn.db.query.EKeyRCursor.prototype.update = function(obj, opt_idx) {
  var index = opt_idx || 0;
 ...
 * @return {!goog.async.Deferred} value.
 */
ydn.db.query.EKeyRCursor.prototype.clear = function(opt_idx) {
  var index = opt_idx || 0;
 ...
 */
ydn.db.query.EKeyRCursor.prototype.hasDone = function() {
  return this.done_;
};
 ...
 */
ydn.db.query.EKeyRCursor.prototype.isExited = function() {
  return this.exited_;
};
 ...
 * Exit cursor
 */
ydn.db.query.EKeyRCursor.prototype.exit = function() {
  this.exited_ = true;
