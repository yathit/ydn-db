...
var test_41_multiEntry = function () {
  var store_name = 'st';
  var db_name = 'test_11_multiEntry_2';
  ...
  var test_for = function (tag_name, count) {
    var done;
    var result;
    ...
    waitForCondition(
      ...
      // Continuation
      function () {
        assertEquals(tag_name + ' count', count, result.length);

        test_count++;
        reachedFinalContinuation = test_count == total_test;
      },
      100, // interval
      1000); // maxTimeout
